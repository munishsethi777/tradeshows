						...
						<div class="row"> 
								<div class="col-lg-2 pull-right">
									<div class="ibox-tools">
                                         <a class="dropdown-toggle text-info" data-toggle="dropdown" href="#" aria-expanded="false">
                                            Last 7 Days <b class="caret"></b> 
                                        </a>
                                        <ul class="dropdown-menu dropdown-user" x-placement="bottom-start" 
                                        		style="width:100px;position: absolute; top: 18px; left: 26px; 
                                        		will-change: top, left;">
                                            <li><a href="#" class="dropdown-item">Last 15 Days</a>
                                            </li>
                                            <li><a href="#" class="dropdown-item">Last 30 Days</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
							...
							<div class="col-sm-15">
		                        <div class="widget bg-gray text-center">
		                        	<div class="row">
		                                ...
		                                <div class="font-bold text-right">98% <i class="fa fa-level-down"></i></div>
									</div>
		                        </div>
		                    </div>
		                    ...
		                    <div class="col-sm-15">
		                        <div class="widget bg-primary text-center">
		                        	<div class="row">
		                                ...
		                                <div class="font-bold text-right">98% <i class="fa fa-level-up"></i></div>
									</div>
		                        </div>
		                    </div>
							...
							<div class="ibox">
								<div class="ibox-title">
	                                ...
	                                <div class="pull-right">
										<div class="ibox-tools">
	                                         <a class="dropdown-toggle text-info" data-toggle="dropdown" href="#" aria-expanded="false">
	                                            Next 7 Days <b class="caret"></b> 
	                                        </a>
	                                        <ul class="dropdown-menu dropdown-user" x-placement="bottom-start" 
	                                        		style="width:100px;position: absolute; top: 18px; left: 26px; 
	                                        		will-change: top, left;">
	                                            <li><a href="#" class="dropdown-item">Next 15 Days</a></li>
	                                            <li><a href="#" class="dropdown-item">Next 30 Days</a></li>
	                                            <li><a href="#" class="dropdown-item">Next 3 Months</a></li>
	                                        </ul>
	                                    </div>
	                                </div>
	                            </div>
	...
	<script type="text/javascript">
	 ...
	 isSelectAll = false;
        $(document).ready(function(){
            ...
            var oilprices = [ [1167692400000, 100], [1167778800000, 110], [1167865200000, 180], 
