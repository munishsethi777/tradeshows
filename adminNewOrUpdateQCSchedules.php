                 ...
                 <div class="ibox-content">
                 	<?include "progress.php"?>
                 	 <form id="importQCScheduleForm" method="post" action="Actions/QCScheduleAction.php" class="m-t-lg">
                     	<input type="hidden" id ="call" name="call"  value="newOrUpdateQcSchedule"/>
						 ...
						 <div class="form-group row i-checksnormal">
							<div class="col-lg-offset-2 col-lg-8">
								<input type="checkbox" id="InsertCase" name="InsertCase" disabled checked> Import Case 
							</div>
						</div>
						<div class="form-group row i-checksnormal">
							<div class="col-lg-offset-2 col-lg-8">
								<input type="checkbox" id="updateCase" name="updateCase" disabled checked> Update Case 
							</div>
						</div>  
