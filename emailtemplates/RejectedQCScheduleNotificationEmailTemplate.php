...
<body>
    <div style="background-color: #f3f3f4; width: 100%; color: #676a6c; font-family: open sans, Helvetica Neue, Helvetica, Arial, sans-serif">
        <div style="background-color: white; margin: auto; max-width: 800px; padding: 0px 15px 0px 15px">
            <div style="min-height: 700px;">
                <div style="padding: 10px; background-color: rgba(26, 178, 147, 0.3) !important; color: white; margin: 0px -15px 0px -15px;">
