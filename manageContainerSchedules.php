...
<body>
	<input id="isAnalyticsDivExpandedUserConfigValue" class="isAnalyticsDivExpandedUserConfigValue" type="hidden" name="isAnalyticsDivExpandedUserConfigValue" value="<?php echo $isAnalyticsContainersDivExpanded;?>" />
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="ibox">
							...
							<div class="modal fade" aria-hidden="true" id="containerScheduleFilterGraphModal">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-sm-12" id="graphContainer">
                                                    <canvas id="containerScheduleFilterGraph"></canvas>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
	...
	function loadReportingData() {
		$.getJSON("Actions/ReportingDataAction.php?call=getReportingData&for=container_",
			function(response) {
	...
	$(document).ready(function() {
		...
		$(".fa-bar-chart").click(function(){
            $("#graphContainer").html("");
            $("#graphContainer").html("<canvas id='containerScheduleFilterGraph'></canvas>");
            var graphIconId = $(this).attr("id");
            $.getJSON("Actions/ContainerScheduleAction.php?call=showFilterGraph&graphIconId=" + graphIconId, (response)=>{
                var graphTitle = response.data.graphTitle;
                $("#containerScheduleFilterGraphModal").modal('show');
                $("#graphTitle").text(graphTitle);
                $("#containerScheduleFilterGraph").html("");
                var ctx = null;
                ctx = document.getElementById("containerScheduleFilterGraph").getContext("2d");
                var chart = null;
                chart = new Chart(ctx,{
                    type:"line",
                    data: {
	...
	function getFilterQueryData() {
		...
		dataArr['emptyreturndate'] = {
			emptyreturndate: conditionDD
		};
		return dataArr
	}
	...
	function loadGrid() {
		...
		var columns = [{
			...
			{
				text: 'terminalappointmentdatetime',
				datafield: 'terminalappointmentdatetime',
				hidden: true,
				filtertype: 'date',
			...
			{
				text: 'emptylfddate',
				datafield: 'emptylfddate',
				hidden: true,
				filtertype: 'date',
				cellsformat: 'M-dd-yyyy'
			},
			{
				text: 'emptyreturndate',
				datafield: 'emptyreturndate',
				hidden: true,
				filtertype: 'date',
				cellsformat: 'M-dd-yyyy',
				filtertype: 'input',
			...
			{
				text: 'samplesreceivedinomsdate',
				datafield: 'samplesreceivedinomsdate',
				hidden: true,
				filtertype: 'date',
				cellsformat: 'M-dd-yyyy'
			},
			{
				text: 'containerreceivedinomsdate',
				datafield: 'containerreceivedinomsdate',
				hidden: true,
				filtertype: 'date',
				cellsformat: 'M-dd-yyyy'
			},
			{
				text: 'msrfcreateddate',
				datafield: 'msrfcreateddate',
				hidden: true,
				filtertype: 'date',
				cellsformat: 'M-dd-yyyy'
			},
			{
				text: 'samplesreceiveddate',
				datafield: 'samplesreceiveddate',
				hidden: true,
				filtertype: 'date',
				cellsformat: 'M-dd-yyyy'
			},
			{
				text: 'containerreceivedinwmsdate',
				datafield: 'containerreceivedinwmsdate',
				hidden: true,
				filtertype: 'date',
				cellsformat: 'M-dd-yyyy'
			},
			{
				text: 'samplesreceivedinwmsdate',
				datafield: 'samplesreceivedinwmsdate',
				hidden: true,
				filtertype: 'date',
				cellsformat: 'M-dd-yyyy'
			},

			{
				...
				datafield: 'container',
				width: "10%",
				cellsrenderer: showitemdetail
			},
			{
				text: 'AWU Ref',
				datafield: 'awureference',
				width: "10%"
			},
			{
				text: 'Trucker',
			...
			{
				text: 'Hot',
				datafield: 'ishotcontainer',
				columntype: "checkbox",
				width: "4%"
			},
			{
				text: 'ETA',
				datafield: 'etadatetime',
				width: "14%",
			...
			{
				text: 'Requested dlvry',
				datafield: 'requesteddeliverydatetime',
				filtertype: 'date',
				cellsformat: 'MM-dd-yyyy',
				width: "12%"
			},
			{
				text: 'Scheduled dlvry',
				datafield: 'scheduleddeliverydatetime',
				filtertype: 'date',
				cellsformat: 'MM-dd-yyyy',
				width: "12%"
			},
			{
				text: 'Confirmed dlvry',
				datafield: 'confirmeddeliverydatetime',
				filtertype: 'date',
				cellsformat: 'MM-dd-yyyy',
				width: "12%"
			},
			{
				text: 'Notification pickup',
				datafield: 'alpinenotificatinpickupdatetime',
				filtertype: 'date',
				cellsformat: 'MM-dd-yyyy',
				width: "13%"
			},
		...
		var source = {
			...
			datafields: [{
				...
				{
					name: 'terminalappointmentdatetime',
					type: 'date'
				},
				{
					name: 'lfdpickupdate',
				...
				{
					name: 'confirmeddeliverydatetime',
					type: 'date'
				},
				{
				...
				{
					name: 'alpinenotificatinpickupdatetime',
					type: 'date'
				},
				{
					name: 'samplesreceivedinomsdate',
					type: 'date'
				},
				{
					name: 'containerreceivedinomsdate',
					type: 'date'
				},
				{
					name: 'msrfcreateddate',
					type: 'date'
				},
				{
					name: 'samplesreceiveddate',
					type: 'date'
				},
				{
					name: 'containerreceivedinwmsdate',
					type: 'date'
				},
				{
					name: 'samplesreceivedinwmsdate',
					type: 'date'
				},
				{
					name: 'container',
