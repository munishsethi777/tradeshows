...
class StringConstants{
	...
	const PROJECT_OVERDUE_REPORT_NAME = "No. projects overdue";
	const PROJECT_COMPLETED_PREVIOUS_REPORT = "ALPINE BI Graphics | Projects Completed Last week";
	const PROJECT_COMPLETED_PREVIOUS_REPORT_NAME = "No. of projected completed previous week";
	const PROJECT_IN_BUYER_REVIEW_REPORT = "ALPINE BI Graphics | Projects in Buyer's Review";
	const PROJECT_IN_BUYER_REVIEW_REPORT_NAME = "No. of projects in buyers review";
	const PROJECT_IN_MANAGER_REVIEW_REPORT = "ALPINE BI Graphics | Projects in Manager's Review";
	const PROJECT_IN_MANAGER_REVIEW_REPORT_NAME = "No. of projects in manager review";
	const PROJECT_IN_ROBBY_REVIEW_REPORT = "ALPINE BI Graphics | Projects in Robby's Review";
	const PROJECT_IN_ROBBY_REVIEW_REPORT_NAME = "No. of projects in Robby review";
	const PROJECT_IN_MISSING_INFO_FROM_CHINA_REPORT = "ALPINE BI Graphics | Projects with Pending Info from China Team";
	const PROJECT_IN_MISSING_INFO_FROM_CHINA_REPORT_NAME = "No. of projects with pending info. From buyers/China";
	const PROJECT_DUE_TODAY_REPORT = "ALPINE BI Graphics | Projects Due for the Day";
	const PROJECT_DUE_TODAY_REPORT_NAME = "List of Items Due for the Day";
