                                        ...
                                        <div id="qcPermissionsDiv" class="panel-body i-checks">
				                            ...
				                            <ul class="col-lg-6 todo-list ui-sortable p-h-xs">
						                        <li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Scheduled Final Inspection Date is in next 14 Days &#10; Actual Final Inspection is Empty"></label>
													<label class="fa fa-question-circle" style="margin-left:0px;" data-toggle="tooltip" data-placement="top" title="Scheduled Middle Inspection Date is in next 14 Days &#10; Actual Middle Inspection is Empty &#10; Approval Middle Inspection Date Reason is Empty"></label>
													<label class="fa fa-question-circle" style="margin-left:0px;" data-toggle="tooltip" data-placement="top" title="Scheduled First Inspection Date is in next 14 Days &#10; Actual First Inspection is Empty &#10; Approval First Inspection Date Reason is Empty"></label>
						                        </li>
						                        <li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Scedule Final Inspection Date is within the next 14 days from current date &#10; Approval Final Inspection Date is Empty &#10; Actual Final Inspection Date is Empty &#10; is not completed"></label>
													<label class="fa fa-question-circle" style="margin-left:0px;" data-toggle="tooltip" data-placement="top" title="Scedule Middle Inspection Date is within the next 14 days from current date &#10; Approval Middle Inspection Date is Empty &#10; Actual Middle Inspection Date is Empty &#10; Approval Middle Inspection Date Reason is empty &#10; is not completed"></label>
													<label class="fa fa-question-circle" style="margin-left:0px;" data-toggle="tooltip" data-placement="top" title="Scedule First Inspection Date is within the next 14 days from current date &#10; Approval First Inspection Date is Empty &#10; Actual First Inspection Date is Empty &#10; Approval First Inspection Date Reason is empty &#10; is not completed"></label>
						                        </li>
						                        <li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Schedule Final Inspection Date is Within the current Date or in the Past &#10; Either Approval Final Inspection Date is Within the current Date or in the past or Approval Final Inspection Date is Empty and Actual Final Inspection Date is Empty &#10; QC Schedule is not completed"></label>
													<label class="fa fa-question-circle" style="margin-left:0px;" data-toggle="tooltip" data-placement="top" title="Actual Final Inspection Date is Empty &#10; Schedule Middle Inspection Date is Within the current Date or in the Past &#10; Either Approval Middle Inspection Date is Within the current Date or in the past or Approval Middle Inspection Date is Empty and Actual Middle Inspection Date is Empty &#10; QC Schedule is not completed"></label>
													<label class="fa fa-question-circle" style="margin-left:0px;" data-toggle="tooltip" data-placement="top" title="Actual Final Inspection Date is Empty Schedule First Inspection Date is Within the current Date or in the Past &#10; Either Approval First Inspection Date is Within the current Date or in the past or Approval First Inspection Date is Empty and Actual First Inspection Date is Empty &#10; QC Schedule is not completed"></label>
						                        </li>
						                        <li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Updating Various Fields using Bulk Functionality"></label>
						                        </li>
											</ul>
						                    ...
						                    <ul class="col-lg-6 todo-list ui-sortable p-xs">
						                    	<li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="QC Schedule Approval Response type is Pending"></label>
						                        </li>
												<li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="A Total QC Planner Report"></label>
						                        </li>
												<li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="QC Schedule Approval Id equals QC Approval Id"></label>
						                        </li>
						                    </ul>
                                        ...
                                        <div id="graphicPermissionsDiv" class="panel-body i-checks">
				                            ...
				                            <ul class="col-lg-6 todo-list ui-sortable p-h-xs">
						                        <li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Graphics Completion Date Not Between CurrentDate &#10; 7 Days From Current Date"></label>
						                        </li>
						                        <li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Final Graphics Due Date is before Current Date &#10; Graphic Completion Date is Empty"></label>
						                        </li>
						                        <li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Graphics Status is Equal to Buyer Reviewing"></label>
						                        </li>
						                        <li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Graphic Status equals to Manager Reviewing"></label>
						                        </li>
												<li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Graphic Status Equals to Robby Reviewing"></label>
						                        </li>
												<li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Graphic Status equals to Missing Info From China"></label>
						                        </li>
						                        <li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Graphic Status Equals Missing From China &#10; Final Graphics Due Date is before Current Date"></label>
						                        </li>
											</ul>
						                    <ul class="col-lg-6 todo-list ui-sortable p-xs">
						                    	<li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Final Graphics Due Date is The Current Date"></label>
						                        </li>
												<li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Date Difference between final Graphic Due Date &#10; China Office Entry Date is less than 20"></label>
						                        </li>
												<li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="If the Graphic Log is Created On  is one day behind the current Date &#10; the Date difference between final graphic due date &#10; current Date is less than 20"></label>
						                        </li>
												<li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Graphics Status Equals to Missing Info From China"></label>
						                        </li>
												<li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Send all Graphics Logs information"></label>
						                        </li>
						                        <li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Sends all Graphics Logs according to Note Name"></label>
						                        </li>
						                         <li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Sends All Graphics Logs information including the Final Graphics Due Date"></label>
						                        </li>
						                    </ul>
                                        ...
                                        <div id='containerPermissionsDiv' class="panel-body i-checks">
				                            ...
				                            <ul class="col-lg-6 todo-list ui-sortable p-h-xs">
						                        <li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="ETA DateTime is Between currentDate and Six days from Current Date"></label>
						                        </li>
						                        <li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Empty Return Date is not between Current Date &#10; Seven Days from Current Date &#10; Empty Return Date is Greater than Empty LFD Date"></label>
						                        </li>
						                        <li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Schedule Delivery DateTime is equal to Current Date"></label>
						                        </li>
						                        <li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Scheduled Delivery DateTime is less than Current Date &#10; Alpine Notification Pickup DateTime is Empty"></label>
						                        </li>
												<li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="ETA DateTime is before Two Days from Current Date &#10; Either ids complete is Empty or unchecked"></label>
						                        </li>
												<li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="LFD Pickup Date is not Empty &#10; Terminal Appointment DateTime is Empty"></label>
						                        </li>
						                        <li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Change between ETA Notes"></label>
						                        </li>
						                        <li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="EmptyNotes is Empty"></label>
						                        </li>
						                        <li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Checks changes between Requested Delievery DateTime &#10; Existing Requested Delivery DateTime"></label>
												</li>
						                   </ul>
						                    ...
						                    <ul class="col-lg-6 todo-list ui-sortable p-xs">
						                    	<li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Terminal Appointment DateTime is not Empty &#10; Schedule Delivery DateTime is Empty"></label>
						                        </li>
												<li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Schedule Delivery DateTime is equal to current Date &#10; confirmed Delivery DateTime is Empty"></label>
						                        </li>
												<li>
												...
												<li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Confirmed Delivery DateTime is not Empty &#10; Either Container Received in OMS Date is Empty or if sample Recovered is checked &#10; sample received in OMS Date is Empty"></label>
						                        </li>
												<li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Check if Alpine Pickup Date is Different from Existing Alpine Pickup Date"></label>
						                        </li>
												<li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Change Between Terminal Appointment Date from Current and Existing Date"></label>
						                        </li>
						                        <li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Change Between Alpine Pickup Notes"></label>
						                        </li>
						                        <li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Sends the count of alpine Notification Pickup DateTime between particular days and Current Date"></label>
												</li>
												<li>
													...
													<label class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Checks changes between Warehouse from Existing Warehouse"></label>
						                        </li>
						                    </ul>
