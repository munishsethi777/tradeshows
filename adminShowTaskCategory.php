...
<body>
		                    ...
		                    <div class="ibox-title">
		                    	 <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
									<a class="navbar-minimalize minimalize-styl-2 btn btn-primary "
										...
										<h4 class="p-h-sm font-normal">Task Categories</h4>
								 </nav>
		                     </div>
   ...
   <form id="form1" name="form1" method="post" action="adminCreateTaskCategory.php">
...
function loadGrid(){
    ...
    var source =
    {
        ...
        url: 'Actions/TaskCategoryAction.php?call=getAllTaskCategories',
        root: 'Rows',
        cache: false,
    ...
    $("#taskCategory").jqxGrid(
    {
        ...
        renderstatusbar: function (statusbar) {
            ...
            addButton.click(function (event) {
                location.href = ("adminCreateTaskCategory.php");
            });
            deleteButton.click(function (event) {
            	deleteRows("taskCategory","Actions/TaskCategoryAction.php?call=deleteTaskCategory");
           });
