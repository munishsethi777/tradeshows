<tr>
	...
	<!-- <td style="border:1px silver solid;width:10%;text-align:right">{PO_INCHARGE}</td> -->
	...
	<td style="border:1px silver solid;width:10%;text-align:right;color:green">{AP_NOTIFICATIONDATE}</td>
</tr>