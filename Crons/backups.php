<?php
class backups extends  DBvars{
    public static function backup_mysql_database() {
        $options = array (
            'db_host' => 'localhost', // mysql host
            'db_uname' => 'alpinebi_munish', // user
            'db_password' => 'Munish#314', // pass
            'db_to_backup' => 'alpinebi_tradeshows', // database name
            'db_backup_path' => '/home/alpinebi/public_html/dbbackups/', // where to backup
