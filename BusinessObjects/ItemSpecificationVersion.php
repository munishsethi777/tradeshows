<?php
class ItemSpecificationVersion{
	...
	public function from_array($object){
		$this->itemno = $object->getItemNo();
		$this->oms = $object->getOms();
		$this->item1description = $object->getItem1Description();
		$this->item1length = $object->getItem1Length();
		$this->item1width = $object->getItem1Width();
		$this->item1height = $object->getItem1Height();
		$this->item2description = $object->getItem2Description();
		$this->item2length = $object->getItem2Length();
		$this->item2width = $object->getItem2Width();
		$this->item2height = $object->getItem2Height();
		$this->item3description = $object->getItem3Description();
		$this->item3length =$object->getItem3Length();
		$this->item3height = $object->getItem3Height();
		$this->item3width = $object->getItem3Width();
		$this->mastercarton1length = $object->getMasterCarton1Length();
		$this->mastercarton1width = $object->getMasterCarton1Width();
		$this->mastercarton1height = $object->getMasterCarton1Height();
		$this->mastercarton2length = $object->getMasterCarton2Length();
		$this->mastercarton2width = $object->getMasterCarton2Width();
		$this->mastercarton2height = $object->getMasterCarton2Height();
		$this->msdescription = $object->getMSDescription();
		$this->port = $object->getPort();
		$this->countryoforigin = $object->getCountryOfOrigin();
		$this->material1 = $object->getMaterial1();
		$this->material1percent = $object->getMaterial1Percent();
		$this->material2 = $object->getMaterial2();
		$this->material2percent = $object->getMaterial2Percent();
		$this->material3 = $object->getMaterial3();
		$this->material3percent = $object->getMaterial3Percent();
		$this->material4 = $object->getMaterial4();
		$this->material4percent = $object->getMaterial4Percent();
		$this->material5 = $object->getMaterial5();
		$this->material5percent = $object->getMaterial5Percent();
		$this->materialtotalpercent = $object->getMaterialTotalPercent();
		$this->haslight = $object->getHasLight();
		$this->lighttype = $object->getLightType();
		$this->totallumens = $object->getTotalLumens();
		$this->hasbattery = $object->getHasBattery();
		$this->batteryquantity = $object->getBatteryQuantity();
		$this->batterytype = $object->getBatteryType();
		$this->haselectricity = $object->getHasElectricity();
		$this->electricitytype = $object->getElectricityType();
		$this->cordlengthfeet = $object->getCordLengthFeet();
		$this->hasassembly = $object->getHasAssembly();
		$this->manualpath = $object->getManualPath();
		$this->part1 = $object->getPart1();
		$this->part2 = $object->getPart2();
		$this->part3 = $object->getPart3();
		$this->part4 = $object->getPart4();
		$this->part5 = $object->getPart5();
		$this->cordlengthmeter = $object->getCordLengthMeter();
		$this->pumpvolts = $object->getPumpVolts();
		$this->pumpwattage = $object->getPumpWattage();
		$this->pumpcordlength = $object->getPumpCordLength();
		$this->transformerwattage = $object->getTransformerWattage();
		$this->transformervolts = $object->getTransformerVolts();
		$this->transformercordlength = $object->getTransformerCordLength();
		$this->watercapacity = $object->getWaterCapacity();
		$this->feature1 = $object->getFeature1();
		$this->feature2 = $object->getFeature2();
		$this->feature3 = $object->getFeature3();
		$this->feature4 = $object->getFeature4();
		$this->feature5 = $object->getFeature5();
		$this->feature6 = $object->getFeature6();
		$this->feature7 = $object->getFeature7();
		$this->updatedby = $object->getUpdatedBy();
		$this->troy = $object->getTroy();
		$this->userseq = $object->getUserSeq();
		$this->createdon = new DateTime();
		$this->lastmodifiedon = new DateTime();
	}
	
	public static $className = "ItemSpecificationVersion";
	public static $tableName = "itemspecificationverions";
